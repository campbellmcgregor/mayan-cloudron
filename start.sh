...
# export MAYAN_DOCUMENTS_STORAGE_BACKEND=storages.backends.s3boto3.S3Boto3Storage,
# export MAYAN_DOCUMENTS_STORAGE_BACKEND_ARGUMENTS="{'access_key':\
#                                                   'yourS3accesskey',\
#                                                   'secret_key':'yourS3secretkey',\
#                                                   'bucket_name':'yourS3bucketname',\
#                                                   'default_acl':'private',\
#                                                   'endpoint_url':'https://address-of-s3-server:9000',\
#                                                   'verify':'False'}"
